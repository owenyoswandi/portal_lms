...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 20, 2025 at 06:10 PM
...
CREATE TABLE `tbl_subtopic` (
  ...
  `st_creadate` timestamp NOT NULL DEFAULT current_timestamp(),
...
INSERT INTO `tbl_subtopic` (`st_id`, `st_t_id`, `st_jenis`, `st_name`, `st_file`, `st_due_date`, `st_creadate`, `st_modidate`) VALUES
(1, 2, 'Test', 'Pretest', NULL, NULL, '2025-01-19 17:00:00', NULL),
(2, 2, 'Modul', 'P2a Pengenalan Toolss', 'uploads/Modul/1737372674_1_5_Energi dan daya Listrik-1.pdf', NULL, '2025-01-20 11:31:14', NULL),
(3, 1, 'Test', 'Pretest', NULL, NULL, '2025-01-20 16:36:16', NULL),
(4, 1, 'Modul', 'P1a Modul Instalasi', 'uploads/Modul/1737391029_1_5_Energi dan daya Listrik-1.pdf', NULL, '2025-01-20 16:37:09', NULL),
(5, 1, 'Test', 'Posttest', NULL, NULL, '2025-01-20 16:38:04', NULL),
(6, 2, 'Task', 'P2b Task : Review Tools', 'uploads/Task/1737391514_1_5_Energi dan daya Listrik-1.pdf', '2025-01-24 17:00:00', '2025-01-20 16:45:14', NULL),
(8, 2, 'Task Collection', 'Hasil Review Tools', NULL, '2025-01-25 16:59:00', '2025-01-20 16:59:54', NULL),
(9, 4, 'Test', 'Pretest', NULL, NULL, '2025-01-20 17:05:53', NULL),
(10, 4, 'Modul', 'Modul Introduction to AI', 'uploads/Modul/1737392778_1_5_Energi dan daya Listrik-1.pdf', NULL, '2025-01-20 17:06:18', NULL),
(11, 5, 'Test', 'Pretest', NULL, NULL, '2025-01-20 17:08:16', NULL),
(12, 5, 'Modul', 'Modul', 'uploads/Modul/1737392927_1_5_Energi dan daya Listrik-1.pdf', NULL, '2025-01-20 17:08:47', NULL),
(14, 6, 'Test', 'Pretest', NULL, NULL, '2025-01-20 17:09:11', NULL),
(15, 6, 'Task', 'Review Pengenalan Tools', 'uploads/Task/1737392984_1_5_Energi dan daya Listrik-1.pdf', '2025-01-29 17:09:00', '2025-01-20 17:09:44', NULL),
(16, 6, 'Task Collection', 'Hasil Reviw', NULL, '2025-01-29 17:09:00', '2025-01-20 17:10:00', NULL);
...
CREATE TABLE `tbl_topic` (
  ...
  `t_creadate` timestamp NOT NULL DEFAULT current_timestamp(),
...
(1, NULL, 'admin', 'admin', 'Administrator', 'SUkabumi', '0856224425', 'Perempuan', '1996-05-19', 'Admin', '2024-01-02 09:18:29', '2025-01-20 16:28:45', 'd4348d3e66be9499ec505e6dc4bb305a78f7ca3bf64ba7a348daed60e60c71fa', 'Bearer', 'ekoabdulgoffar129@gmail.com', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL),
(2, NULL, 'fatwa', 'fatwa', 'Fatwa Paramadhani', 'SUkabumi', '08562244255', 'Perempuan', '1996-05-19', 'Peserta', '2024-01-02 09:18:29', '2025-01-20 12:04:33', '5600cba7b9a00f9ec7962abaf9be3b1e3e3ac168c25e0f859376a24eaa34d2d8', 'Bearer', '', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL);
