...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Mar 2025 pada 15.43
...
--
-- Struktur dari tabel `tbl_activities`
--
...
--
-- Dumping data untuk tabel `tbl_activities`
--
...
(10, 1, 'Master User', 'Membuat CRUD', '2025-02-28', '2025-03-01', 'Low', NULL, NULL, 'Done', '00:00:00', '0%', 2, '2025-02-28 14:25:54', '2025-02-28 14:26:19'),
(11, 1, 'Create UI Product', 'Create UI Product', '2025-03-02', '2025-03-03', 'Very Low', '2025-03-03', '2025-03-03', 'Review', '01:00:00', '50%', 3, '2025-03-02 06:41:01', '2025-03-02 06:45:36');
...
--
-- Struktur dari tabel `tbl_hasil_test`
--
...
--
-- Dumping data untuk tabel `tbl_hasil_test`
--

INSERT INTO `tbl_hasil_test` (`hasil_id`, `peserta_id`, `subtopic_id`, `waktu_respon`) VALUES
(1, 2, 1, '2025-02-28 21:19:34'),
(2, 2, 1, '2025-03-02 13:23:33'),
(3, 2, 1, '2025-03-02 13:25:17'),
(4, 2, 1, '2025-03-02 13:27:32');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_hasil_test_detail`
--
...
--
-- Dumping data untuk tabel `tbl_hasil_test_detail`
--
...
(2, 2, 1, 1, NULL, NULL),
(3, 4, 1, 1, NULL, NULL),
(4, 4, 4, NULL, 'Machine learning adalah', 10);
...
(1, 1, 'Pretest', 'Pengolahan otomatis oleh mesin mempelajari pola berdasarkan data, disebut', 'pilihan_ganda', 5),
(2, 1, 'Pretest', 'Pengolahan otomatis oleh mesin mempelajari pola berdasarkan data, disebut', 'pilihan_ganda', 5),
(3, 1, 'Pretest', 'Pengolahan otomatis oleh mesin mempelajari pola berdasarkan data, disebut', 'pilihan_ganda', 5),
(4, 1, 'Pretest', 'Apakah yang dimaksud dengan Machine Learning ?', 'isian', 0);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_phases`
--
...
CREATE TABLE `tbl_phases` (
  ...
  `phase_desc` text COLLATE utf8mb4_unicode_ci,
...
--
-- Dumping data untuk tabel `tbl_phases`
--

INSERT INTO `tbl_phases` (`phase_id`, `project_id`, `phase_name`, `phase_desc`, `status`, `start_date`, `end_date`, `created_at`, `updated_at`) VALUES
(1, 1, 'Phase prep', 'init github repo and init regular meeting', 'created', '2025-02-04', '2025-02-06', '2025-02-09 10:39:18', '2025-03-02 06:39:44'),
...
--
-- Struktur dari tabel `tbl_role_projects`
--

CREATE TABLE `tbl_role_projects` (
  `rolep_id` bigint(20) UNSIGNED NOT NULL,
  `project_id` bigint(20) UNSIGNED NOT NULL,
  `rolep_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `rolep_desc` text COLLATE utf8mb4_unicode_ci,
...
--
-- Dumping data untuk tabel `tbl_role_projects`
--
...
(1, 1, 'Project Manager', 'manage project', 0, '2025-02-09 10:39:18', '2025-03-02 06:39:44'),
...
(15, 1, 'Frontend Developer', 'Dev Bagian UI', 1, '2025-03-02 06:39:44', '2025-03-02 06:39:44');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_submission`
--
...
--
-- Struktur dari tabel `tbl_subtopic`
--
...
--
-- Dumping data untuk tabel `tbl_subtopic`
--
...
(1, 2, 'Test', 'Pretest', NULL, '2025-02-28 13:42:57', '2025-03-01 13:48:00', 10, 5, '2025-01-19 17:00:00', '2025-03-01 23:56:36'),
...
--
-- Struktur dari tabel `tbl_subtopic_test`
--
...
--
-- Dumping data untuk tabel `tbl_subtopic_test`
--
...
--
-- Struktur dari tabel `tbl_task_assignments`
--
...
--
-- Struktur dari tabel `tbl_team_members`
--
...
--
-- Dumping data untuk tabel `tbl_team_members`
--
...
(12, 2, 1, 1, '2025-02-26 17:00:00', '2025-02-28 14:24:29', '2025-03-02 06:39:44'),
(13, 3, 1, 15, '2025-03-01 17:00:00', '2025-03-02 06:39:44', '2025-03-02 06:39:44');

-- --------------------------------------------------------

--
-- Struktur dari tabel `tbl_topic`
--
...
--
-- Dumping data untuk tabel `tbl_topic`
--
...
(1, NULL, 'admin', 'admin', 'Administrator', 'SUkabumi', '0856224425', 'Perempuan', '1996-05-19', 'Admin', '2024-01-02 09:18:29', '2025-03-02 14:26:08', '92f6ba73c7049e55de577f1b4793b9e2c4230567c93f27ce9cad1b77b6a513a1', 'Bearer', 'ekoabdulgoffar129@gmail.com', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL),
(2, NULL, 'fatwa', 'fatwa', 'Fatwa Paramadhani', 'SUkabumi', '08562244255', 'Perempuan', '1996-05-19', 'Peserta', '2024-01-02 09:18:29', '2025-03-02 13:58:34', '21174fc8ef82836bca3d22d7b71a9eb32a328cd02b2ad9f8a29755202a9c569e', 'Bearer', '', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL),
(3, NULL, 'qq', 'qq123', 'qq', 'Ponorogo', '08562244255', 'Perempuan', '1996-05-19', 'Peserta', '2025-02-13 14:42:57', '2025-03-02 06:43:59', '7d7a75929d0d3885efbf3bbd7cbeff53963696a9f79f3f00b5ab2fbf3b2fd6dd', 'Bearer', 'qq@mail.com', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL);
...
--
-- Indeks untuk tabel `tbl_activities`
--
...
--
-- Indeks untuk tabel `tbl_hasil_test`
--
ALTER TABLE `tbl_hasil_test`
  ADD PRIMARY KEY (`hasil_id`) USING BTREE;

--
-- Indeks untuk tabel `tbl_hasil_test_detail`
--
...
--
-- Indeks untuk tabel `tbl_pilihan_jawaban`
--
...
--
-- Indeks untuk tabel `tbl_role_projects`
--
...
--
-- Indeks untuk tabel `tbl_submission`
--
ALTER TABLE `tbl_submission`
  ADD PRIMARY KEY (`sm_id`) USING BTREE;

--
-- Indeks untuk tabel `tbl_subtopic`
--
...
--
-- Indeks untuk tabel `tbl_task_assignments`
--
...
--
-- Indeks untuk tabel `tbl_team_members`
--
...
--
-- AUTO_INCREMENT untuk tabel `tbl_activities`
--
ALTER TABLE `tbl_activities`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_hasil_test`
--
ALTER TABLE `tbl_hasil_test`
  MODIFY `hasil_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT untuk tabel `tbl_hasil_test_detail`
--
ALTER TABLE `tbl_hasil_test_detail`
  MODIFY `hasil_id_detail` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT untuk tabel `tbl_phases`
--
ALTER TABLE `tbl_phases`
  MODIFY `phase_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT untuk tabel `tbl_pilihan_jawaban`
--
ALTER TABLE `tbl_pilihan_jawaban`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_role_projects`
--
ALTER TABLE `tbl_role_projects`
  MODIFY `rolep_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT untuk tabel `tbl_submission`
--
ALTER TABLE `tbl_submission`
  MODIFY `sm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `tbl_subtopic`
--
ALTER TABLE `tbl_subtopic`
...
--
-- AUTO_INCREMENT untuk tabel `tbl_task_assignments`
--
ALTER TABLE `tbl_task_assignments`
  MODIFY `assignment_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_team_members`
--
ALTER TABLE `tbl_team_members`
  MODIFY `member_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT untuk tabel `tbl_topic`
--
ALTER TABLE `tbl_topic`
