...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Feb 2025 pada 10.01
...
(12, '2025_02_02_171452_create_tbl_projects_table', 2),
(13, '2025_02_02_171551_create_tbl_phases_table', 2),
(14, '2025_02_02_171709_create_tbl_role_projects_table', 2);
...
INSERT INTO `tbl_phases` (`phase_id`, `project_id`, `phase_name`, `phase_desc`, `start_date`, `end_date`, `status`, `created_at`, `updated_at`) VALUES
(1, 2, 'Updated Phase', 'Updated Phase Description', '2024-01-14', '2024-03-31', NULL, '2025-02-02 13:59:15', '2025-02-02 14:03:13');
...
INSERT INTO `tbl_projects` (`project_id`, `user_id`, `project_name`, `project_desc`, `start_date`, `end_date`, `status`, `created_at`, `updated_at`) VALUES
(2, 1, 'Project A', 'Project Description', '2024-01-14', '2024-12-31', 'active', '2025-02-02 13:59:15', '2025-02-02 13:59:15');
...
(1, 2, 'Updated Role', 'Updated Role Description', '2025-02-02 13:59:15', '2025-02-02 14:03:13');
...
(1, NULL, 'admin', 'admin', 'Administrator', 'SUkabumi', '0856224425', 'Perempuan', '1996-05-19', 'Admin', '2024-01-02 09:18:29', '2025-02-03 02:58:24', 'd8a6bbe59029f2d25aa5ffee8e0e066264a037b7e0bb6b021de4fcfa4866c187', 'Bearer', 'ekoabdulgoffar129@gmail.com', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL),
(2, NULL, 'fatwa', 'fatwa', 'Fatwa Paramadhani', 'SUkabumi', '08562244255', 'Perempuan', '1996-05-19', 'Peserta', '2024-01-02 09:18:29', '2025-01-30 13:15:56', '96e1c025d4e7a1fa915fbb2782110e0e51e31c55b3b44e958ee2b8e55722e136', 'Bearer', '', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL);
...
ALTER TABLE `tbl_hasil_test_detail`
  ADD PRIMARY KEY (`hasil_id_detail`),
...
--
ALTER TABLE `tbl_phases`
  MODIFY `phase_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_role_projects`
  MODIFY `rolep_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Ketidakleluasaan untuk tabel `tbl_hasil_test_detail`
--
ALTER TABLE `tbl_hasil_test_detail`
...
--
-- Ketidakleluasaan untuk tabel `tbl_role_projects`
--
ALTER TABLE `tbl_role_projects`
