...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 16 Feb 2025 pada 19.00
...
INSERT INTO `tbl_activities` (`activity_id`, `phase_id`, `activity_name`, `activity_desc`, `start_date`, `end_date`, `complexity`, `status`, `duration`, `completion`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 1, 'Updated Database Design', 'Updated database schema design', '2024-02-13', '2024-02-20', 'High', 'Completed', '03:30:00', '100%', 1, '2025-02-13 16:45:23', '2025-02-13 16:48:14');
...
INSERT INTO `tbl_feedback` (`feedback_id`, `course_id`, `user_id`, `feedback`, `rating`, `created_at`, `modified_at`) VALUES
(1, 1, 2, 'couse bagus', 4, '2025-01-30 20:23:11', '2025-01-30 20:23:11');
...
(4, 1, 'Pretest', 'test', 'pilihan_ganda'),
(5, 2, 'Pretest', 'test', 'pilihan_ganda'),
(8, 2, 'Pretest', 'isian 22', 'isian');
...
(6, 6, 'fase prep', 'balala', 'in_progress', '2025-02-09', '2025-02-15', '2025-02-09 11:51:33', '2025-02-13 15:38:12'),
(7, 6, 'fase development', 'blalala', 'created', '2025-02-10', '2025-02-16', '2025-02-09 12:20:05', '2025-02-13 15:38:12'),
(8, 6, 'fase testing', 'balalala', 'created', '2025-02-24', '2025-02-28', '2025-02-13 15:14:26', '2025-02-13 15:38:12');
...
(2, 1, 'Deep Learning', 0),
(3, 1, 'Recommender System', 0),
(4, 1, 'Computer Vision', 0),
(5, 1, 'Data Science', 0);
...
(6, 'project wacana', 2, 'balala oioioi', '2025-02-09', '2025-02-23', '', '2025-02-09 11:51:33', '2025-02-13 15:38:12');
...
INSERT INTO `tbl_role_projects` (`rolep_id`, `project_id`, `rolep_name`, `rolep_desc`, `created_at`, `updated_at`) VALUES
(1, 1, 'Project Manager', 'manage project', '2025-02-09 10:39:18', '2025-02-09 13:12:26'),
(6, 6, 'pm', 'ppm', '2025-02-09 11:51:33', '2025-02-13 15:38:12'),
(7, 2, 'pm', 'pmpmpm', '2025-02-09 13:10:57', '2025-02-09 13:11:09'),
(8, 6, 'Fullstack engineer', 'yaa', '2025-02-13 14:45:05', '2025-02-13 15:38:12');
...
(3, 1, 'Test', 'Pretest', NULL, '2025-01-22 13:42:57', '2025-02-21 10:17:00', 30, 2, '2025-01-20 16:36:16', NULL),
...
(3, 2, 6, 6, '2025-02-04 17:00:00', '2025-02-09 12:44:46', '2025-02-13 15:38:12'),
(4, 2, 2, 7, '2025-02-07 17:00:00', '2025-02-09 13:10:57', '2025-02-09 13:11:09'),
(5, 3, 6, 8, '2025-02-10 17:00:00', '2025-02-13 14:45:05', '2025-02-13 15:38:12');
...
(1, NULL, 'admin', 'admin', 'Administrator', 'SUkabumi', '0856224425', 'Perempuan', '1996-05-19', 'Admin', '2024-01-02 09:18:29', '2025-02-16 15:52:32', '05707c9ae65214b3016fed05e50a1e6a813e873e430e8366baf28101c2318093', 'Bearer', 'ekoabdulgoffar129@gmail.com', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL),
(2, NULL, 'fatwa', 'fatwa', 'Fatwa Paramadhani', 'SUkabumi', '08562244255', 'Perempuan', '1996-05-19', 'Peserta', '2024-01-02 09:18:29', '2025-02-14 13:13:53', 'd73d74d14cd4ee13d289cd97220980da51e20bcbc08778e518a2dabb22a3fda6', 'Bearer', '', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL),
(3, NULL, 'qq', 'qq123', 'qq', 'Ponorogo', '08562244255', 'Perempuan', '1996-05-19', 'Peserta', '2025-02-13 14:42:57', '2025-02-13 14:45:52', '12d202ba01132d52ad1d52352544bad8bb7ebf5b4b5cc0952facfe17145288fd', 'Bearer', 'qq@mail.com', '32', '3202070002', '3202070', '3202', NULL, NULL, NULL, 0, 0, NULL);
...
--
ALTER TABLE `tbl_pilihan_jawaban`
  MODIFY `pilihan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
